...
export class QuadTree {
    ...
    constructor(boundary: BoundingBox, capacity: number = 4, maxDepth: number = 8, currentDepth: number = 0) {
    ...
    query(range: BoundingBox): PhysicObject[] {
        ...
        if (cachedResult && currentTime - this.lastUpdateTime < QuadTree.CACHE_LIFETIME) {
            return cachedResult;
        }
